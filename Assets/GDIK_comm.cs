...
public class GDIK_comm : MonoBehaviour
{
    ...
    void Update()
    {
        // Check if object position has been set by OpenCV via Python
    ...
    // Start a UDP listener for receiving the object position from Python
